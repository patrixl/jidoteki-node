...
(function() {
  ...
  module.exports.getToken = function(callback) {
    var resource;
    resource = '/auth/user';
    return _this.makeHMAC("POSThttps://" + _this.api.hostname + "/v0" + resource, function(signature) {
  ...
  module.exports.getData = function(type, resource, callback) {
    return _this.makeHMAC("" + (type.toUpperCase()) + "https://" + jido.api.hostname + "/v0" + resource, function(signature) {
      return jido.api.get({
        url: "/v0" + resource,
        headers: {
